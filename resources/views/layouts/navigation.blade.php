        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:space-x-8 sm:ml-10">
                    ...
                    <x-nav-link :href="route('occupants.index')" :active="request()->routeIs('occupants.index')">
                        {{ __('Guests') }}
                    </x-nav-link>
                    ...
                    @if(Auth::user()->name === 'Amir' && Auth::user()->email === 'amir.rai.pokhara@gmail.com')
                    <x-nav-link :href="route('view-change')" :active="request()->routeIs('view-change')">
                        {{ __('Users') }}
                    </x-nav-link>
                    @endif
            ...
            <div class=" sm:flex sm:items-center sm:ml-6" style="float: right">
